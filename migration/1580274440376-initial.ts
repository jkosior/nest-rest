...
export class initial1580274440376 implements MigrationInterface {
    name = 'initial1580274440376'

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "cart" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdDateTime" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, "lastChangedDateTime" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, "description" character varying(300), "owner" character varying NOT NULL, "totalPrice" double precision NOT NULL DEFAULT 0, "isCheckedOut" boolean NOT NULL DEFAULT false, "currency" character varying NOT NULL DEFAULT 'USD', "products" json, CONSTRAINT "PK_c524ec48751b9b5bcfbf6e59be7" PRIMARY KEY ("id"))`, undefined);
